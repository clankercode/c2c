...
- Bug #4 (debug log PID prefix): **fully done** — `[pid=N]` on every log line (c2c.ts:745), boot banner with pid+sha256 (line 171), log rotation on init (line 164). "Partially done" was stale.
