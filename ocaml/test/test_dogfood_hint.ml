...
let m_dm = C2c_mcp.{ from_alias = "alice"; to_alias = "bob"; content = "hi bob, please review #123"; deferrable = false; reply_via = Some "c2c_send"; enc_status = None; ts = 1700000000.0; ephemeral = false; message_id = None }
let m_room = C2c_mcp.{ from_alias = "alice"; to_alias = "bob#swarm-lounge"; content = "lounge ping"; deferrable = false; reply_via = Some "c2c_send"; enc_status = None; ts = 1700000000.0; ephemeral = false; message_id = None }
let m_relay = C2c_mcp.{ from_alias = "alice"; to_alias = "bob#abcdef012345"; content = "relay ping"; deferrable = false; reply_via = Some "c2c_send"; enc_status = None; ts = 1700000000.0; ephemeral = false; message_id = None }
