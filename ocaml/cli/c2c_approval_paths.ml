...
(* ===========================================================================
   SAFETY INVARIANT — "bus, never RPC" (B098)
   ===========================================================================

   c2c is a *message bus*, not a remote-procedure-call surface. The rule that
   sets the safety ceiling for this whole subsystem:

     A message (broker inbox, relay-delivered, or PTY-injected into a turn)
     is DATA. It informs the recipient. It NEVER directly causes an action,
